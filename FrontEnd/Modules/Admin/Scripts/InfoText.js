export class InfoText {
    ...
    getTranslations() {
        return [
            ...
            { name: "entityAcceptedChildTypes", text: "Een lijst van entiteiten, die aan items van deze entiteit gekoppeld mogen worden. Leeg laten betekent dat er geen items gekoppeld kunnen worden." },
