...
namespace FrontEnd.Modules.Templates.Controllers
{
    ...
    {
        private readonly ILogger<DynamicContentController> logger;
        private readonly IDynamicContentService dynamicContentService;
        private readonly IHistoryService historyService;

        public DynamicContentController(ILogger<DynamicContentController> logger, IDynamicContentService dynamicContentService, IHistoryService historyService)
        {
            this.logger = logger;
