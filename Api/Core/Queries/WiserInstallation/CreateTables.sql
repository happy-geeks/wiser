...
CREATE TABLE IF NOT EXISTS `wiser_itemdetail`  (
  ...
  INDEX `key_value`(`key`(50), `value`(100)) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `wiser_itemlinkdetail`  (
  ...
  `long_value` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `itemlink_key`(`itemlink_id`, `key`, `language_code`) USING BTREE,
  INDEX `key_value`(`key`(50), `value`(100)) USING BTREE,
  INDEX `itemlink_id_key_value`(`itemlink_id`, `key`(40), `value`(40)) USING BTREE,
  INDEX `item_id_group`(`itemlink_id`, `groupname`, `key`(40)) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE IF NOT EXISTS `wiser_module`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `custom_query` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `count_query` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
CREATE TABLE IF NOT EXISTS `wiser_communication_generated`  (
  ...
  `bcc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  ...
  `wiser_item_files` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'One or more IDs from wiser_itemfile that should be sent with the communication as attachments. Only works for e-mail communications.',
  `attempt_count` int NOT NULL DEFAULT 0,
  `last_attempt` datetime NULL,
  `is_internal_error_mail` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'If the WTS was not able to send a communication after X tries, it will send an e-mail to notify us about the problem. For these e-mails, this column will be set to 1, so that we can use that to make sure we do not send too many errors.',
  PRIMARY KEY (`id`) USING BTREE,
