...
namespace Api.Modules.EntityTypes.Interfaces
{
    ...
    public interface IEntityTypesService
    {
        ...
        Task<ServiceResult<List<EntityTypeModel>>> GetAvailableEntityTypesAsync(ClaimsIdentity identity, int moduleId, string parentId = null, string parentEntityType = null);
