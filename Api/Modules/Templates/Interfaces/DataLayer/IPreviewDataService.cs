...
namespace Api.Modules.Templates.Interfaces.DataLayer
{
    ...
    public interface IPreviewDataService
    {
        ...
        public Task<List<PreviewProfileDao>> GetAsync(int templateId);
        ...
        public Task<int> CreateAsync(PreviewProfileDao profile, int templateId);
        ...
        public Task<int> UpdateAsync(PreviewProfileDao profile, int templateId);
        ...
        public Task<int> DeleteAsync(int templateId, int profileId);
    }
}
