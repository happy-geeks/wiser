...
namespace Api.Modules.Templates.Interfaces
{
    ...
    public interface IPreviewService
    {
        ...
        public Task<ServiceResult<List<PreviewProfileModel>>> GetPreviewProfiles(int templateId);
        ...
        public Task<ServiceResult<PreviewProfileModel>> CreatePreviewProfile(PreviewProfileModel profile, int templateId);
        ...
        /// <param name="templateId"></param>
        public Task<ServiceResult<bool>> EditPreviewProfile(PreviewProfileModel profile, int templateId);
        ...
        public Task<ServiceResult<bool>> RemovePreviewProfile(int templateId, int profileId);
    }
}
