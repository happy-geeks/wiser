...
namespace Api.Modules.Templates.Interfaces
{
    ...
    public interface IPreviewService
    {
        ...
        public Task<ServiceResult<List<PreviewProfileModel>>> Get(int templateId);
        ...
        public Task<ServiceResult<PreviewProfileModel>> Create(PreviewProfileModel profile, int templateId);
        ...
        /// <param name="templateId"></param>
        public Task<ServiceResult<bool>> Update(PreviewProfileModel profile, int templateId);
        ...
        public Task<ServiceResult<bool>> Delete(int templateId, int profileId);
    }
}
