...
public class HistoryService : IHistoryService, IScopedService
{
    ...
    private TemplateHistoryModel GenerateHistoryModelForTemplates(TemplateSettingsModel newVersion, TemplateSettingsModel oldVersion)
    {
        ...
        var oldLinkedTemplates = newVersion.LinkedTemplates.RawLinkList.Split([','], StringSplitOptions.RemoveEmptyEntries);
        var newLinkedTemplates = oldVersion.LinkedTemplates.RawLinkList.Split([','], StringSplitOptions.RemoveEmptyEntries);
    ...
    private static void CheckIfValuesMatchAndSaveChangesToHistoryModel(string propName, TemplateTypes type, object newValue, object oldValue, TemplateHistoryModel templateModel)
    {
        ...
        templateModel.TemplateChanges.Add(propName, new Tuple<object, object, TemplateTypes>(newValue, oldValue, type));
    }
