namespace Api.Modules.StyledOutput.Models
{
    /// <summary>
    /// A model for returning data for a Wiser item in a tree view.
    /// </summary>
    public class StyledOutputTreeViewItemModel
    {
		/*
        /// <summary>
...
*/
        ...
        /// <summary>
        /// a style sheet id number for when this item represents a style sheet item
        /// </summary>
