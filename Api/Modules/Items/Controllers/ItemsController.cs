...
namespace Api.Modules.Items.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        {
            return (await itemsService.GetItemsForTreeViewAsync(moduleId, (ClaimsIdentity)User.Identity, parentEntityType, encryptedItemId,orderBy, checkId, linkType, childEntityTypes)).GetHttpResponseMessage();
        }
